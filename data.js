const profileData = {
  ...
  experience: [
    ...
    },
    {
      ...
      company: "PicturifyAI",
      details: "Développement d'un funnel marketing de conversion data-driven et alimenté par l'IA. Collecte, traitement et structuration de données de leads. Déploiement d'un modèle de machine learning pour la prédiction de conversion et automatisation du workflow via des outils no-code."
    },
    {
    ...
    },
    {
      ...
      details: "Automatisation de la collecte de données de véhicules (images, marque, modèle) depuis plusieurs sources. Structuration des données et restitution via des tableaux de bord."
    },
    {
  ...
  projects: [
    {
      ...
      description: "Développement d'un système multi-agents capable de découvrir et expliquer les liens entre concepts de disciplines differentes. Agents asynchrones, réponses personnalisées selon le profil utilisateur et détection des biais.",
      tags: ["Agentic AI", "LLM", "Multi-agents", "Flask", "Python"],
      github_link: "https://github.com/IThioye/multi-agent-system-demo",
      demo_link: "#",
    ...
    },
    {
      ...
      company: "PicturifyAI",
      description: "Modèle de machine learning pour prédire la conversion de leads marketing et automatisation complète du funnel data-driven.",
